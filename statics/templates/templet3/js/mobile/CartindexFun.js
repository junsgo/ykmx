    ...
    var b = function() {
        ...
        var m = function() {
            ...
            if (r > 0) {
                ...
                g.children("p").html('总共梦想<span class="orange arial z-user">' + r + '</span>个商品  合计金额：<span class="orange arial">' + q + ".00</span> 元")
            } else {
                g.remove()
            }
        };
        ...
        var p = function(r, u) {
            ...
            if (r > 100) {
                if (q.length == 0) {
                    var s = $('<div class="z-Cart-tips">已超过100人次，梦想存在一定风险，请谨慎参与！</div>');
                    t.prepend(s)
                }
            } else {
                q.remove()
            ...
            var s = function(w) {
                if (w.code == 1) {
                    ...
                    if (w.code == 0) {
                        ...
                        q.parent().prev().html('总共梦想：<em class="arial">' + r + '</em>人次/<em class="orange arial">￥' + r*yunjiage + ".00</em>")
                    }
                }
            };
