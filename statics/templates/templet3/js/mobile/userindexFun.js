				  ...
				  //alert(I.count)
                    if (I.code == 0) {
                        ...
                        for (var D = 0; D < C; D++) {
                            ...
                            if (F.codeState == 3) {
                                E += '<p class="mValue">价值：￥' + F.money + '</p><span>获得者：<a style="color: #22AAff" href="'+Gobal.Webpath+'/mobile/mobile/userindex/' + F.q_uid + '">' + F.q_user + '</a><br>幸运梦想码：<em class="orange">' + F.q_user_code + "</em></span>"
                            } else {
                        ...
                        if (I.code == 1) {
                            ...
                            if (I.code == 2) {
                                m.append('<div class="haveNot z-minheight"><s></s><p>TA未有公开的梦想记录哦</p></div>')
                            } else {
                                m.append(s);
                                BuyRecordFun.CountFalg = false
                            }
                ...
                var y = function(z) {
                    ...
                    if (z.code == 0) {
                        ...
                        for (var A = 0; A < E; A++) {
                            ...
                            B += '<span>幸运梦想码：<em class="orange">' + C.q_user_code + "</em><br>揭晓时间：" + C.q_end_time + " </span></li></ul>"
                        }
                        e.append(B);
                        s = "";
                        loadImgFun();
