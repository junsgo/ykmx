	...
	<div class="GuideW">
		...
		<div class="Guidebor clearfix">
			<ul class="Guide-Explain clearfix">
				<li class="Explain-l ExplainA"><p>选择一款商品，点击“立即1块梦想”</p><img src="<?php echo G_UPLOAD_PATH; ?>/newbie/Guide_3.jpg" border="0" alt=""></li>
			...
			<ul class="Guide-Explain clearfix">
				...
				<li class="Explain-r ExplainB"><p>支付1元，购买1人次，获得1个“梦想码”</p><img src="<?php echo G_UPLOAD_PATH; ?>/newbie/Guide_7.jpg" border="0" alt=""></li>
			</ul>
			<div class="Guide-Separate">
				<img src="<?php echo G_UPLOAD_PATH; ?>/newbie/Guide_5.jpg" border="0" alt="">
			</div>
			...
			<div class="Rule clearfix">
				...
				<ul class="Rule-Exp">
					<li>每件商品参考市场价平分成相应“等份”，每份1元，1份对应1个梦想码。</li>
					<li>同一件商品可以购买多次或一次购买多份。</li>
					<li>当一件商品所有“等份”全部售出后计算出“幸运梦想码”，拥有“幸运梦想码”者即可获得此商品。</li>
				</ul>
			</div>
			<div class="Rule clearfix Rulemat">
				...
				<ul class="Rule-Exp">
					...
					<li>将这100组数值之和除以商品总需参与人次后取余数，余数加上10,000,001即为“幸运梦想码”。</li>
				</ul>
			</div>
