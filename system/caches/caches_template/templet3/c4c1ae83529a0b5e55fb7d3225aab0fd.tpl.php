...
<div class="goods_hot">
	<div class="hot_title" style="border-bottom:none;">
		<h3>最新揭晓</h3>
		<?php $zxjx_idnumber=$this->DB()->GetList("select count(id) as idnumber from `@#_shoplist` where `q_end_time` is not null and `q_showtime` = 'N'",array("type"=>1,"key"=>'',"cache"=>0)); ?>		
		...
		<div class="hot" style="">
			<ul id="hostGoodsItems" class="hot-list">											
				...
				<li class="list-block">
					...
					<div class="shop_buttom"><a href="<?php echo WEB_PATH; ?>/goods/<?php echo $renqi['id']; ?>" target="_blank" class="shop_but" title="立即1块梦想"></a></div>
				</li>
				<?php  endforeach; $ln++; unset($ln); ?>
			</ul>
		</div>
			...
			<div class="buyList">		
                <ul id="buyList" style="margin-top: 0px;">
					...
					<li>
						...
						<span class="who"><p style="display: inline;"><a class="blue" href="<?php echo WEB_PATH; ?>/uname/<?php echo idjia($gorecord['uid']); ?>"><?php echo get_user_name($gorecord); ?></a></p>刚刚梦想了</span>
	...
	<ul id="readyLotteryItems" class="hot-list">
		...
		<li class="list-block">
			...
			<div class="shop_buttom">
				<a href="<?php echo WEB_PATH; ?>/goods/<?php echo $shop['id']; ?>" target="_blank" class="shop_but" title="立即1块梦想"></a>
