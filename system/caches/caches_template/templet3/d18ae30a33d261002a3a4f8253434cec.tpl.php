...
<div class="show_content">
	...
	<div class="Pro_Details">
		...
		<div class="Pro_Detright">
				...
				<div class="Announced_FrameGet">
					<dl>
						<dd class="gray02">
							...
							<p>梦想时间：<?php echo microt($user_shop_time); ?></p>
						</dd>
					</dl>
				</div>
			...
			<div class="MaCenter">
				<p>商品获得者本期总共梦想了<em class="orange"><?php echo $user_shop_number; ?></em>人次</p>
	...
	<div id="divCalResult" class="Product_Content">	
		<div class="ygRecord" name="div_tab">
				<div class="yghelp">
					...
					<br>
					3、将这100个数值之和除以该商品总参与人次后取余数，余数加上10000001 即为“幸运梦想码”。
					<?php if(!$item['q_content']): ?>
					<br>
					<b>由于网站还未满100条购买记录。所以按照   10000001 + (揭晓时间求和结果*100/参与人数) 的余数   即为“幸运梦想码”。</b>
					<?php endif; ?>
				</div>
				...
				<ul class="Record_title">
					<li class="time">梦想时间</li>
					<li class="nem">会员账号</li>
					<li class="name">商品名称</li>
					<li class="much">梦想人次</li>
				</ul>
				...
				<div class="FloatBox"></div>	
				   ...
				   <ul class="Record_content">
					...
					<div class="RecordOnehundred"><h4> 100条计算结果 </h4>
					 <div class="ResultBox"><h2>计算结果</h2>
						<p class="num4">求和：
							<span class="Fb"><?php echo $item['q_counttime']; ?></span>(上面100条梦想记录时间取值相加之和)<br>取余：
