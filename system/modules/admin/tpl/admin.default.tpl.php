...
<div class="lr10 CMS_message" id="roll">
    <?php if(!empty($yungou_alert)){?>
    <?php echo $yungou_alert;?>
    <?php }else{?>
...
<!------------>
    ...
    <div class="div-about width30">
        ...
        <ul>
            ...
            <li><i>程序开发:</i>北京华鼎腾盛信息技术有限公司</li>
            <li><i>版权所有:</i>北京华鼎腾盛信息技术有限公司</li>
            <li><i>官方微博:</i><a href="http://www.weibo.com" target="_black" style="color:#0f0">关注官方微博</a></li>
        </ul>
            <p style="color:#666; padding:20px;font: 12px/1.5 tahoma,arial,宋体b8b\4f53,sans-serif;">
            	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;此系统是一款专为一块梦想设计的CMS系统,
                具有圈子,限时揭晓,晒单等功能。
            </p> 
    </div>
<!------------>
